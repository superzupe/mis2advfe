...
import { ButtonLoaded } from "../common/Loaded";

const AuthButton = ({ type, loading }) => {
  const isLogin = type === "login";

  const classBase =
    "flex flex-col justify-center items-center px-0 py-2 font-bold text-sm border-none rounded-lg cursor-pointer md:px-0 md:py-2.5 md:text-base";
  ...
  return (
    <>
      ...
      >
        {loading ? <ButtonLoaded /> : isLogin ? "Masuk" : "Daftar"}
      </button>
      <Link
