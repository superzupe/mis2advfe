...
const AuthForm = ({ type }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isLogin && form.password.trim() !== form.confirmPassword.trim()) {
    ...
    try {
      ...
      if (isLogin) {
        ...
        const fullPhone = `${form.countryCode} ${form.phone}`; //untuk mengirim kode dan no tel secara bersamaan
        ...
        alert("Akun berhasil dibuat, silahkan login untuk melanjutkan.");
        navigate("/login");
      }
    } catch (err) {
      console.error(err);
